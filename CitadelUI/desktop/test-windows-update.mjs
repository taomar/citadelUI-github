...
try {
  await run('gh', [
    'release', 'download', 'citadel-ui-desktop-v1.1.3', '--repo', 'taomar/citadelUI-github',
  ...
  assert.equal(hash.digest('hex'), 'ae100efe63f32378c8ca4fb1ccd579185ec5b8b6ec432fa6ac6f7bed58634a87',
  ...
  console.log(JSON.stringify({
    ...
    from: '1.1.3', to: version, retainedState: true, applicationRevision: identity.applicationRevision, passed: true,
  }));
} finally {
  if (server) {
