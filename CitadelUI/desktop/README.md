...
Version v1.1.5 combines application revision
`128d269ca6f4dcd8a1d3ea011dc345dc8d153c3c` with the Windows/macOS Electron
...
For the exact released source, use tag `citadel-ui-desktop-v1.1.5`, following the
...
identifier. See the [release details](../RELEASE.md#desktop-v115-compatibility-release).
...
(for example `v1.1.5 | 128d269`); each release also attaches
