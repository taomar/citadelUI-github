...
The examples pin `citadel-ui-desktop-v1.1.7`, including application revision
`772b49ff0a09a937a267c08c21f80c3247d6c1e6`. Compare the complete build commit
...
The complete released build is pinned by tag `citadel-ui-desktop-v1.1.7`;
the [release details](RELEASE.md#desktop-v117-read-only-discovery-and-wizard) describe its
artifacts. Version v1.1.7 integrates application revision `772b49f` from
