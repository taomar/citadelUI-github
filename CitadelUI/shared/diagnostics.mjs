...
export const DIAGNOSTIC_CODES = Object.freeze([
  ...
  'INVALID_CONFIGURATION', 'CONFIGURATION_VERSION', 'CONFIGURATION_RETARGET',
  'EXCLUDED_NATIVE_SOURCE', 'NATIVE_SYNTAX', 'NATIVE_EXPRESSION', 'NATIVE_DUPLICATE',
  'NATIVE_LIMIT', 'NATIVE_NUMBER', 'NATIVE_NUMBER_SYNTAX', 'NATIVE_NUMBER_GRAMMAR',
  'NATIVE_PARSER_UNAVAILABLE', 'NATIVE_STALE_OPERATION', 'NATIVE_EDIT_OVERLAP',
  'NATIVE_ROOT_SIGNATURE', 'NATIVE_VALUE_MISSING', 'NATIVE_SENSITIVE_FILE',
  'NATIVE_FIELD_READ_ONLY', 'NATIVE_POLICY_XML', 'NATIVE_VALIDATION',
  'NATIVE_PROOF_REQUIRED', 'NATIVE_REVIEW_STALE', 'NATIVE_DRAFT_IDENTITY',
  'NATIVE_SOURCE_RETARGET', 'NATIVE_SOURCE_SCOPE', 'NATIVE_OWNERSHIP_OVERLAP',
  'NATIVE_IDENTITY_OVERLAP', 'NATIVE_HISTORY_SCOPE', 'NATIVE_HISTORY_STALE',
  'NATIVE_CREATION_UNCONFIRMED', 'NATIVE_WORKSPACE_UNAVAILABLE',
  'NATIVE_WORKSPACE_REQUIRED', 'NATIVE_TRANSPORT', 'NATIVE_TARGET',
]);
...
export const DIAGNOSTIC_MODULES = Object.freeze([
  ...
  'workspace-service', 'workspace-settings-view', 'workspace-view-state',
  'github-head-state', 'native-controls', 'native-workspace-selection',
  ...
  'terraform-export', 'terraform-literals', 'zip', 'workspace-configuration',
  'terraform/parser', 'terraform/schema', 'terraform/workspace', 'terraform/review',
  'terraform/drafts', 'terraform/vendor/tree-sitter',
...
export const DIAGNOSTIC_RESOURCES = Object.freeze([
  ...
  '/shared/terraform/vendor/tree-sitter.wasm', '/shared/terraform/vendor/hcl.wasm',
  '/shared/terraform/vendor/json.wasm',
  ...
  '/api/github/repos/:repositoryId/native-inventory',
