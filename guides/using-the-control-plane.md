...
Use desktop **Microsoft Edge or Google Chrome**. Local folder access requires
the File System Access API and a secure browser context: HTTPS when hosted,
or the supported local origin <http://127.0.0.1:4173>. Keep the same origin and
browser profile to retain folder permissions.
